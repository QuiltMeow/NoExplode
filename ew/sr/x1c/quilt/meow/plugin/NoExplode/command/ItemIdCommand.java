...
public class ItemIdCommand implements CommandExecutor {
    ...
    private static final IDLibrary PLUGIN = (IDLibrary) Bukkit.getPluginManager().getPlugin("ID-Library");
    ...
    public static ItemInfo getItemInfo(ItemStack item) {
        ...
        return new ItemInfo(type.name(), PLUGIN.getID(type));
    }
    ...
    private static void showItemInfo(CommandSender sender, Material material) {
        sender.sendMessage(ChatColor.GREEN + "道具名稱 : " + material.name() + " 代碼 : " + PLUGIN.getIDData(material));
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        switch (args.length) {
            ...
            case 1: {
                String input = args[0];
                Material material = PLUGIN.getMaterial(input);
                if (material == null) {
